...
# Цель лабораторной работы — описать выбранную ранее предметную область при помощи иерархии классов. Обеспечить вывод иерархии при помощи метода test(), вызывающего ее строковое представление.
