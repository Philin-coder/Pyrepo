...
from tested.row_sum_while_package import row_sum
from tested.row_sum_while_package.row_sum import row_sum_func
import doctest
...
class RowDumForTest(TestCase):
    def test_row_sum_while_int_in_input(self):
        self.assertEqual(row_sum_func(a=12, n=2), 18.0)

    def test_row_sum_while_zero_in_input(self):
        self.assertEqual(row_sum_func(a=0, n=0), 0)

    def test_row_sum_while_char_in_input(self):
