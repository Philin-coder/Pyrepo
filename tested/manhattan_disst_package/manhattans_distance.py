def manhattan_distance_func(v1: list, v2: list) -> [float, int]:
    """
    Манхетенское  расстояние между объектами
    :param v1: списоок координат первого объекта
    :param v2: списоок координат второго  объекта
    :return:Манхетенское  расстояние между объектами
    >>> manhattan_distance_func(v1=[12.0, 11.0, 2], v2=[11.0, 9.0, 1.0])
    4.0
    >>> manhattan_distance_func(v1=[12.0], v2=[11.0])
    1.0
